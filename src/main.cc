//　Copyright Hao Wang, Waseda University.
...
int main(int argc, char **argv)
{
    ...
    for (int i = 1; i < argc; i++)
    {
        ...
        else
        {
            ...
            cerr << "  --filter     <double>  : filter threshold for alignment.       \t[default=" << filter << "]\n\n";
    ...
    if (!train.empty())
    {
        ...
        if (!model.compare("ibm1"))
        {
            ...
            ibm1_forward.Config(true, stoi(iterations), true, sw2id.size());
            ...
            ibm1_backward.Config(false, stoi(iterations), true, tw2id.size());
        ...
        else if (!model.compare("vbibm1"))
        {
            ...
            vbibm1_forward.Config(true, stoi(iterations), true, sw2id.size());
            cerr << "# training VBIBM1 in forward direction ..." << endl;
            vbibm1_forward.TrainModel(trainCorpus, stod(prior));

            vbibm1_backward.Config(false, stoi(iterations), true, tw2id.size());
        ...
        else if (!model.compare("ibm1_vb"))
        {
            ...
            cerr << "# initializing IBM model 1 Viterbi probabilities using EM algorithm." << endl;

            cerr << "# training IBM1 Viterbi in forward direction ..." << endl;
            ibm1_vb_forward.Config(true, stoi(iterations), true, sw2id.size());
            ...
            ibm1_vb_backward.Config(false, stoi(iterations), true, tw2id.size());
        ...
        else if (!model.compare("vbibm1_vb"))
        {
            ...
            vbibm1_vb_forward.Config(true, stoi(iterations), true, sw2id.size());
            ...
            vbibm1_vb_backward.Config(false, stoi(iterations), true, tw2id.size());
        ...
        else if (!model.compare("ibm1_vbh"))
        {
            ...
            ibm1_vbh_forward.Config(true, stoi(iterations), true, sw2id.size());
            ...
            ibm1_vbh_backward.Config(false, stoi(iterations), true, tw2id.size());
        ...
        else if (!model.compare("vbibm1_vbh"))
        {
            ...
            vbibm1_vbh_forward.Config(true, stoi(iterations), true, sw2id.size());
            ...
            vbibm1_vbh_backward.Config(false, stoi(iterations), true, tw2id.size());
